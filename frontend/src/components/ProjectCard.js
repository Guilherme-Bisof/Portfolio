...
export default function ProjectCard({ project, onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-gray-900/50 rounded-lg p-6 flex flex-col h-full border border-cyan-400/30 shadow-[0_0_10px_rgba(0,255,255,0.1)] cursor-pointer hover:border-cyan-400/80 hover:shadow-[0_0_15px_rgba(0,255,255,0.3)]  transition-all size-3"
    >
