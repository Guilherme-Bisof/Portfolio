// Não precisamos mais do "use client" ou hooks, pois este componente agora é estático.
import { FaLinkedin, FaEnvelope } from 'react-icons/fa';

// Componente para um botão de contato individual, para não repetir código
function ContactButton({ href, icon, text }) {
  // Usamos a tag <a> pois são links externos
  return (
    <a 
      href={href}
      target="_blank"
...
export default function ContactSection() {
  ...
  return (
    <section id="contato" className="flex flex-col items-center py-24 bg-black text-white">
      <div className="w-full max-w-4xl px-4 text-center">
        
        {/* Título com a linha de destaque */}
        ...
        <p className="max-w-xl mx-auto my-8 text-gray-400">
          Gostou do que viu? Ficarei feliz em conectar com você. Sinta-se à vontade para me contatar através de um dos canais abaixo.
        </p>
